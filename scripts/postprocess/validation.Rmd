...
ggsave("expSummary.png",device = "png",width = 8,height = 8)
```
...
ggsave("comparisonSummary.png",device = "png",width = 8,height = 8)
```
...
HumanKneeOA_Damage <-c("GSE57218_1","GSE57218_2","E-MTAB-4304_1")
...
IL1B_treatment <- c("E-GEOD-6119_1","GSE104793_1","GSE68428_2","GSE72575_4","GSE75181_2")
DifferentiatingOsteoblasts <- c("GSE53982_1","GSE53982_2","E-MTAB-1391_1","E-MTAB-1391_2","E-MTAB-1391_3")
TGFB_BMP <- c("GSE13604_1","E-GEOD-18648_1","E-GEOD-18648_2","E-MTAB-2450_1","GSE29233_1","GSE13837_1","GSE13837_2","GSE13837_3","GSE13837_4","GSE13837_5","GSE13837_6","GSE13837_7","GSE13837_8","GSE13837_9","GSE13837_10","GSE13837_11","GSE13837_12")
...
comparisons <-list(HumanKneeOA_Damage,RA,MCDS,IL1B_treatment,DifferentiatingOsteoblasts,TGFB_BMP,SuperficalvsDeepZone,Polycomb)
names(comparisons) <- c("HumanKneeOA_Damage","RA","MCDS","IL1B_treatment","DifferentiatingOsteoblasts","TGFB_BMP","SuperficalvsDeepZone","Polycomb")
...
write_excel_csv(dat,path = "ValidationExps.xls")
...
# ggplot(similarityData,aes(y=value,x=key)) + geom_violin(fill="darkgrey") + cowplot::theme_cowplot(font_size = 20) + theme(legend.title=element_blank()) + scale_y_continuous(name = "Rank") + scale_x_discrete(name = "Similarity Method")

ggsave(filename = "validation.png",width = 7,height=4)
...
g <- lapply(similarities, function(x) {
    # 
    # ggplot(x,aes(x=key,y=value)) + geom_violin(fill="darkgrey") + cowplot::theme_cowplot(font_size = 20) + theme(legend.title=element_blank()) + scale_y_continuous(name = "Rank") + scale_x_discrete(name = "Method")
...
ggsave(g[[1]],filename = "bias_species.svg",width = 10,height=7)
ggsave(g[[2]],filename = "bias_platform.svg",width = 10,height=7)
ggsave(g[[3]],filename = "bias_tissue.svg",width = 10,height=7)
