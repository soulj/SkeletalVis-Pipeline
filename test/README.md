Directory of test R scripts used as a test harness/evironment for developing the R scripts that are deployed to the [Sybil Galaxy instance](https://secure.sybil-fp7.eu/galaxy/).
